...
page_meta_lab_list = Page(META_LAB_LIST)
page_meta_lab_details = Page(META_LAB_DETAILS)
...
page_meta_lab_list.link(button=GOTO_MAIN, destination=page_main)
page_meta_lab_details.link(button=GOTO_MAIN, destination=page_main)
page_meta_dos_reward.link(button=GOTO_MAIN, destination=page_main)
page_meta_lab_list.link(button=BACK_ARROW, destination=page_meta_menu)
page_meta_lab_details.link(button=BACK_ARROW, destination=page_meta_lab_list)
page_meta_lab_list.link(button=META_LAB_LIST_GOTO_DETAILS, destination=page_meta_lab_details)
...
page_meta_beacon.link(button=BEACON_REWARD_ENTER, destination=page_meta_lab_details)
...
#page_reshmenu.link(button=RESHMENU_GOTO_META, destination=page_meta_lab_list) unneeded with new UI meta pages
