...
from module.ui.page import Page, page_academy, page_campaign, page_event, page_main, page_main_white, page_sp, page_meta_lab, page_meta_lab_list, page_meta_lab_details
